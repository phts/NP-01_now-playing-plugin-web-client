...
const DEFAULT_DATE_FORMAT: ClockProps['dateFormat'] = {
  year: undefined,
  month: 'short',
  day: 'numeric',
  weekday: undefined
...
const DEFAULT_TIME_FORMAT: ClockProps['timeFormat'] = {
  hour: 'numeric',
  minute: 'numeric',
  second: undefined,
  hour12: true
...
function DockedClock() {
  ...
  const dateFormat: ClockProps['dateFormat'] = (settings.dateFormat === 'custom') ? {
  ...
  const timeFormat: ClockProps['timeFormat'] = (settings.timeFormat === 'custom') ? {
